function [shapevars,shapevars_history,result,resultVec,init_transformed,transformed,sil_pts,init_pointvars] = fit_model_to_image_saveIntermediateSteps(project, model, image)
...
% where E is the energy described in the paper.
    function [energy Jdata] = calc_energy_newImage(vars)
        ...
        % save intermediate shapevars
        shapevars_history{iterNum} = vars(mvs:mve);
        iterNum = iterNum + 1;
